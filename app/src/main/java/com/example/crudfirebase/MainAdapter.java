    ...
    protected void onBindViewHolder(@NonNull myViewHolder holder, final int position, @NonNull MainModel model) {
        ...
        holder.editar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                EditText nombre = view.findViewById(R.id.nombretextedit);
                EditText apellido = view.findViewById(R.id.apellidotextedit);
                EditText email = view.findViewById(R.id.emailtextedit);
                EditText img = view.findViewById(R.id.imgltextedit);
                ...
                actualizar.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        map.put("ImgURL", img.getText().toString());
                        ...
                        FirebaseDatabase.getInstance().getReference().child("Programación Android")
                                ...
                                .addOnSuccessListener(new OnSuccessListener<Void>() {
                                    ...
                                    public void onSuccess(Void unused) {
                                        Toast.makeText(holder.nombre.getContext(), "Actualización Completa", Toast.LENGTH_SHORT).show();
                                        dialogPlus.dismiss();
                                    }
